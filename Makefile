...
ACLOCAL = ${SHELL} /u/ldai1/ccl-build/netgauge/config/missing --run aclocal-1.11
AMTAR = ${SHELL} /u/ldai1/ccl-build/netgauge/config/missing --run tar
AR = ar
ARSPU = 
AUTOCONF = ${SHELL} /u/ldai1/ccl-build/netgauge/config/missing --run autoconf
AUTOHEADER = ${SHELL} /u/ldai1/ccl-build/netgauge/config/missing --run autoheader
AUTOMAKE = ${SHELL} /u/ldai1/ccl-build/netgauge/config/missing --run automake-1.11
AWK = gawk
...
LDFLAGS = -L/u/ldai1/ccl-build/netgauge -L/u/ldai1/ccl-build/netgauge/libnccl -L/u/ldai1/ccl-build/nccl/build/lib -L/sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/cuda-11.8.0-vfixfmc/lib64 -L/sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/openmpi-4.1.6-lranp74/lib -L/usr/lib64 -L/usr/local/lib64 -libverbs
LIBOBJS = 
LIBS = -lc -lm -lMyNcclCode -lnccl -lcudart -lmpi -lpthread
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /u/ldai1/ccl-build/netgauge/config/missing --run makeinfo
...
STRIP = strip
VERSION = 2.4.6
abs_builddir = /u/ldai1/ccl-build/netgauge
abs_srcdir = /u/ldai1/ccl-build/netgauge
abs_top_builddir = /u/ldai1/ccl-build/netgauge
abs_top_srcdir = /u/ldai1/ccl-build/netgauge
...
install_sh = ${SHELL} /u/ldai1/ccl-build/netgauge/config/install-sh
