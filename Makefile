...
ACLOCAL = ${SHELL} /u/ldai1/ccl-build/netgauge_default/config/missing --run aclocal-1.11
AMTAR = ${SHELL} /u/ldai1/ccl-build/netgauge_default/config/missing --run tar
AR = ar
ARSPU = 
AUTOCONF = ${SHELL} /u/ldai1/ccl-build/netgauge_default/config/missing --run autoconf
AUTOHEADER = ${SHELL} /u/ldai1/ccl-build/netgauge_default/config/missing --run autoheader
AUTOMAKE = ${SHELL} /u/ldai1/ccl-build/netgauge_default/config/missing --run automake-1.11
AWK = gawk
CC = /sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/openmpi-4.1.6-lranp74/bin/mpicc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = /sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/openmpi-4.1.6-lranp74/bin/mpicc -E
CPPFLAGS = 
CXX = /sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/openmpi-4.1.6-lranp74/bin/mpicxx
CXXCPP = /sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/openmpi-4.1.6-lranp74/bin/mpicxx -E
...
LDFLAGS = -L/u/ldai1/ccl-build/netgauge_default -L/sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/cuda-11.8.0-vfixfmc/lib64 -L/sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/openmpi-4.1.6-lranp74/lib -L/usr/lib64 -L/usr/local/lib64 -libverbs
LIBOBJS = 
LIBS = -lc -lm -lcudart -lmpi -lpthread
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /u/ldai1/ccl-build/netgauge_default/config/missing --run makeinfo
...
STRIP = strip
VERSION = 2.4.6
abs_builddir = /u/ldai1/ccl-build/netgauge_default
abs_srcdir = /u/ldai1/ccl-build/netgauge_default
abs_top_builddir = /u/ldai1/ccl-build/netgauge_default
abs_top_srcdir = /u/ldai1/ccl-build/netgauge_default
ac_ct_CC = /sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/gcc-11.4.0/openmpi-4.1.6-lranp74/bin/mpicc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /u/ldai1/ccl-build/netgauge_default/config/install-sh
